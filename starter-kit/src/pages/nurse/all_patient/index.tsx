...
const defaultColumns = [
  ...
  },
  {
    ...
    field: 'balance',
    headerName: 'Онош',
    renderCell: ({ row }: CellType) => <Typography variant='body2'>{row.company}</Typography>
  },
  {
    flex: 0.1,
    minWidth: 90,
    field: 'address',
    headerName: 'Ажлын хаяг',
  ...
  },
  {
    ...
    field: 'contact',
    headerName: 'Утас',
    renderCell: ({ row }: CellType) => <Typography variant='body2'>{row.contact}</Typography>
  }
]
