...
export const fetchData = createAsyncThunk('appInvoice/fetchData', async (params: DataParams) => {
  const data: { invoices: InvoiceType[] } = {
    invoices: [
      {
        id: 4987,
        issuedDate: `13 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Paid',
        balance: '$724',
        dueDate: `23 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 4988,
        issuedDate: `17 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        balance: 0,
        dueDate: `15 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 4989,
        issuedDate: `19 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Paid',
        balance: 0,
        dueDate: `03 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 4990,
        issuedDate: `06 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Sent',
        balance: 0,
        dueDate: `11 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 4991,
        issuedDate: `08 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Draft',
        balance: '$815',
        dueDate: `30 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 4992,
        issuedDate: `26 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Paid',
        balance: 0,
        dueDate: `24 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 4993,
        issuedDate: `17 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Draft',
        balance: '$407',
        dueDate: `22 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 4994,
        issuedDate: `11 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Paid',
        balance: '-$205',
        dueDate: `10 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 4995,
        issuedDate: `26 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      {
        id: 4996,
        issuedDate: `15 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Downloaded',
        balance: '$305',
        dueDate: `02 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 4997,
        issuedDate: `27 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        balance: '$666',
        dueDate: `18 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 4998,
        issuedDate: `31 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Partial Payment',
        balance: 0,
        dueDate: `17 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 4999,
        issuedDate: `14 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Paid',
        balance: 0,
        dueDate: `01 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 5000,
        issuedDate: `21 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      {
        id: 5001,
        issuedDate: `30 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      },
      {
        ...
        invoiceStatus: 'Partial Payment',
        balance: '-$253',
        dueDate: `16 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 5005,
        issuedDate: `30 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      {
        id: 5006,
        issuedDate: `10 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Downloaded',
        balance: '$883',
        dueDate: `12 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 5007,
        issuedDate: `01 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Sent',
        balance: 0,
        dueDate: `19 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 5008,
        issuedDate: `22 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      },
      {
        ...
        invoiceStatus: 'Downloaded',
        balance: 0,
        dueDate: `08 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 5011,
        issuedDate: `01 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      {
        id: 5013,
        issuedDate: `05 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      {
        id: 5015,
        issuedDate: `16 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      {
        id: 5016,
        issuedDate: `24 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      },
      {
        ...
        invoiceStatus: 'Partial Payment',
        balance: '-$153',
        dueDate: `25 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 5018,
        issuedDate: `29 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      {
        id: 5019,
        issuedDate: `07 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Partial Payment',
        balance: '-$459',
        dueDate: `14 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 5020,
        issuedDate: `10 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Past Due',
        balance: 0,
        dueDate: `28 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 5021,
        issuedDate: `02 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Sent',
        balance: 0,
        dueDate: `06 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 5022,
        issuedDate: `02 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
        ...
        invoiceStatus: 'Sent',
        balance: 0,
        dueDate: `09 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 5023,
        issuedDate: `23 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      {
        id: 5024,
        issuedDate: `28 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      },
      {
        ...
        invoiceStatus: 'Downloaded',
        balance: 0,
        dueDate: `07 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 5026,
        issuedDate: `24 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      },
      {
        ...
        invoiceStatus: 'Sent',
        balance: 0,
        dueDate: `04 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`
      },
      {
        id: 5028,
        issuedDate: `18 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      {
        id: 5033,
        issuedDate: `12 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
      ...
      {
        id: 5035,
        issuedDate: `20 ${new Date().toLocaleString('default', { month: 'short' })} ${new Date().getFullYear()}`,
